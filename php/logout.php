 ...
 * Logout page
 *
 * Users go to this page, but they don't actually ever see it.
 *
 ...
 *	09/01/2013 - Added exit; as the last line below header.
 */
 
	require_once './includes/constants.php';
	session_start();							//Initialize the running session
	session_destroy();							//Destroy it
	header( 'Location: http://'._ROOT_URL_ );	//Redirect back to the homepage.
	exit;
